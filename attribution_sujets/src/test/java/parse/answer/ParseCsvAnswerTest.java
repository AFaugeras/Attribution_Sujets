...
import parse.answer.ParserCsvAnswer;
...
public void testSuppressionDoublon() throws IOException{
	File f = new File("");
	f = CsvHelper.getRessource(f.getAbsolutePath()+f.separator+"donnees"+f.separator+"UnitTest"+f.separator+"Choix_avec_doublon.csv");
